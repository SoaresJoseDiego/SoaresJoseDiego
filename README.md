...
**Desenvolvedor Full Stack** — .NET e Spring Boot no back-end, Angular e TypeScript no front-end.

Sou apaixonado pelo mundo da tecnologia e venho investindo tempo e muita dedicação para aprender, evoluir e construir soluções cada vez melhores.
...
![Visitas no perfil](https://komarev.com/ghpvc/?username=SoaresJoseDiego\&color=0A66C2\&label=Visitas\&style=flat-square)
...
| **[Simple Product CRUD](https://github.com/SoaresJoseDiego/Simple-Product-CRUD-)** | CRUD desenvolvido para praticar meus conhecimentos iniciais em Spring e explorar o ecossistema Java após minha experiência com .NET.                       | Java · Spring Boot   |
